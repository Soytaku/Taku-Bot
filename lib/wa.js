...
exports.sendFakeStatus2 = (from, teks) => {
        samu330.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '𝚃𝙰𝙺𝚄-𝙱𝙾𝚃', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
}
...
exports.FakeStatusImgForwarded = (from, image, caption) => {                                                                                                                             samu330.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '📌Taku-Bot', "jpegThumbnail": fs.readFileSync(`./src/help.jpg`)} } }, caption: caption, contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
...
exports.sendPdf = async(from, buffer, title = "Taku.pdf") => {
